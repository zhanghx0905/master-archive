...
> For the users who cannot use VirtualBox, we provide an available Docker image `csit6000o/latest` as an alternative. This is not quite the same as what we mentioned in the previous lab. Please carefully refer to the [README][Docker Image] for use.
