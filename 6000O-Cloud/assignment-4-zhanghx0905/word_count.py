...
def wordCount(wordListRDD):
    ...
    wordPairsRDD = wordListRDD.map(lambda word: (word.lower(), 1))
...
# TODO: Replace <FILL IN> with appropriate code
shakespeareWordsRDD = shakespeareRDD.flatMap(str.split)
...
# MAGIC 
# MAGIC Use the `wordCount()` function and `takeOrdered()` to obtain the ten most common words and their counts.
